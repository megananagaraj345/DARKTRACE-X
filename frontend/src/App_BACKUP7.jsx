...
function App() {
  ...
  const evidenceNodes =
    ...
    <>
      <style>{`
        /* DARKTRACE-X Batch 15: responsive presentation only.
           Intelligence logic and API behavior remain unchanged. */
    ...
    async function loadAdvancedIntelligence() {
      try {
        ...
        setAdvancedIntelligence({
          ...
          resolution: resolutionJson || localAdvanced.resolution,
